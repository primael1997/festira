    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Reservation de Standes</a></div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Reservation de Standes</h2>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('admin.standes.index') }}" method="GET">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="buttons text-center">
                                                ...
                                                <a href="{{route('admin.standes.edit',$stand->id)}}" class="btn btn-icon btn-success"><i class="far fa-edit"></i></a>
