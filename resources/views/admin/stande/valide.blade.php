    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Standes Validés</a></div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Liste de standes validés</h2>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('admin.stande.valide') }}" method="GET">
