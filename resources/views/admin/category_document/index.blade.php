    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Catégories Document</a></div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Liste des Catégories Document</h2>

            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Liste des Catégories Document</h4>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="addCategory">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.category-document.store')}}" method="POST">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="editCategory-{{$category->id}}">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                @php
                    $cat = \App\Models\CategoryDocument::where('id',$category->id)->first();
                @endphp
                <form action="{{route('admin.category-document.update',$cat->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
