    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Demande de Sponsort</a></div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Demande de Sponsort</h2>

            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Les Sponsorts en attente</h4>
                            <div class="card-header-action d-flex align-items-center gap-2">
                                {{-- <label for=""><i class="fas fa-filter" style="font-size: 150%"></i></label> --}}
                                <form action="{{ route('admin.sponsort.index') }}" method="GET">
                                ...
                                <a href="{{route('admin.sponsort.create')}}" class="ml-2 btn btn-primary"><i class="fas fa-plus"></i> Ajouter</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="buttons text-center">
                                                ...
                                                <a href="{{route('admin.sponsort.edit',$sponsort->id)}}" class="btn btn-icon btn-success"><i class="far fa-edit"></i></a>
                                    ...
                                    @empty
                                        <tr>
                                            <td class="text-center" colspan="6">Pas de sponsort</td>
                                        </tr>
                                    @endforelse
                                </table>
                            </div>
