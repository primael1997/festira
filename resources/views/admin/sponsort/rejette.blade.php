    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Les sponsorts rejettés</a></div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Liste de sponsort rejettés</h2>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action d-flex align-items-center gap-2">
                                ...
                                <form action="{{ route('admin.sponsort.rejette') }}" method="GET">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-md">
                                    ...
                                    @empty
                                        <tr>
                                            <td class="text-center" colspan="6">Pas de sponsort rejetés</td>
                                        </tr>
                                    @endforelse
                                </table>
                            </div>
